...
const PremiumConfirmDialog = dynamic(
  () => import('@/components/ui/premium-confirm-dialog'),
  { ssr: false }
);

const globalForNotify = typeof globalThis !== 'undefined' ? globalThis : global;
const NotifyContext =
  globalForNotify.__macquulClientNotifyContext ??
  (globalForNotify.__macquulClientNotifyContext = createContext(null));
